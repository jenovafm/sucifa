...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "⚡ Andini <3 ⚡")
    ALIVE_PIC = os.environ.get("ALIVE_PIC", "https://i.ibb.co/8m4Wssg/uci.jpg")
    ...
    PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", "https://i.ibb.co/8m4Wssg/uci.jpg")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/jenovafm/suciandini")
