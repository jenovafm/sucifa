...
CmdHelp("auto_profile").add_command(
  'autobio', None, 'Changes your bio with time. Need to set BIO_MSG in vars(optional)'
).add_command(
  'autoname', None, 'Changes your name with time according to your ALIVE_NAME in var'
).add_command(
