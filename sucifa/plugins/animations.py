...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Base](jenovafm/suciandini)**",
        f"**Build started by user** {hell_mention}",
        f"**Deploy** `25090312` **by user** **{hell_mention}**",
        ...
        "__INFO:Andini:Logged in as 25090312__",
        "__INFO:Andini:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
